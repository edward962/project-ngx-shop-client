...
import { ICategoryState, ICategory } from '@root-store/reducers/categories.reducer';
...
export class HomeComponent extends UnSubscriber implements OnInit, OnDestroy {
	...
	public loading$: Observable<boolean> = this._store.select(loadingSuggestedProductAndCategories);
	...
	public constructor(private readonly _store: Store<IStore>, private readonly _fb: FormBuilder) {
		super();
	}
